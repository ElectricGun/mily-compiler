...
Do note that the standard library is currently not implemented as a part of the compiler, but a set of external files located in [std/](https://github.com/ElectricGun/mily-compiler/tree/main/std).
